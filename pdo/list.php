...
<head>
	<meta charset="utf-8" />
	<style type="text/css">
		body {font-size: 0.8em;font-family: dotum;line-height: 1.6em;}
		header {border-bottom: 1px solid #ccc;padding: 20px 0;}
		nav {float: left;margin-right: 20px;min-height: 1000px;min-width:150px;border-right: 1px solid #ccc;}
    ...
    <body id="body">
        <div>
            ...
            <article>
				...
				<div class="date">
					<?=htmlspecialchars($topic['created'])?>
				</div>
                <div>
